/*
* gol.c
* This function is used for ncurses library
*/
#include <stdlib.h>
#include <stdio.h>
#include <stdbool.h>
...
Here we used pthread and ncurses library to run it. Using these we can take output
from eclipse, linux terminal and thereby in Beaglebone Black also.
from update_env
}
